...
package cn.zhuatech.fileclassifier.controller;
 ...
 */
@RestController
@RequestMapping("/api/fileclassifier")
...
public class WorkspaceController {
     ...
     */
    @GetMapping("/health")
    public Map<String, String> health() { return Map.of("status", "UP", "project", "zhuatech-fileclassifier"); }
